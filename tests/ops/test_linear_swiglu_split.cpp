...
// Two BF16 ulp of the largest output, and two ulp of relative L2. A column rank evaluates the
// whole-weight dot products of its rows, and a row split adds two BF16 roundings of partials
// comparable to the result, so about one ulp is the expected difference rather than the limit.
