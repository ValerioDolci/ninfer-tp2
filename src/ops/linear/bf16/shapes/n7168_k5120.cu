...
// Two-device output-row half of [14336,5120]. It inherits the parent's measured schedules;
// they have not been re-measured at this shape.
namespace {
using Geometry = Bf16Geometry<7168, 5120>;
...
Bf16Launch select_bf16_n7168_k5120(std::int32_t tokens) {
