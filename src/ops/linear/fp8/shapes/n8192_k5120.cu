...
// Two-device output-row half of [16384,5120]. It inherits the parent's measured schedules and
...
const Fp8LinearShape kFp8N8192K5120{8192, 5120, launch_fp8_a16_chunks<10, select_a16>,
