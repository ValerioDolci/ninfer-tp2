...
void causal_attention_small_t_fp8_launch(
    ...
    throw std::invalid_argument("causal_attention_small_t_fp8_launch: unsupported head geometry");
}
...
void causal_attention_cached_small_t_fp8_launch(const Tensor& q, const Tensor& positions,
    ...
    throw std::invalid_argument(
        "causal_attention_cached_small_t_fp8_launch: unsupported head geometry");
}
