...
void causal_attention_small_t_k8v4_launch(
    ...
    throw std::invalid_argument("causal_attention_small_t_k8v4_launch: unsupported head geometry");
}
...
void causal_attention_cached_small_t_k8v4_launch(const Tensor& q, const Tensor& positions,
    ...
    throw std::invalid_argument(
        "causal_attention_cached_small_t_k8v4_launch: unsupported head geometry");
}
