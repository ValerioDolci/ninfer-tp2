...
// region with cudaErrorStreamCaptureUnsupported (measured on CUDA 13.1 / driver 580.178.04),
// which would make the entire tensor-parallel decode program uncapturable
