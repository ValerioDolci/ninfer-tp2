...
void launch_mma(const Weight& weight, Tensor& residual, Fp8A8Workspace workspace,
    ...
    if constexpr (Schedule::kSharedBytes > 48 * 1024) {
        ...
        attribute.ensure(fp8_mma_kernel<Geometry, Schedule, FullTokens, Fp8AddResidualEpilogue,
                                        Fp8ContiguousOutput>,
...
void fp8_linear_add_a8_launch(const Tensor& x, const Weight& weight, Tensor& residual,
    ...
    case Fp8GeometryId::N5120K3072:
        launch_problem<Fp8N5120K3072>(weight, residual, scratch, x.ne[1], stream);
        return;
    case Fp8GeometryId::N5120K8704:
        launch_problem<Fp8N5120K8704>(weight, residual, scratch, x.ne[1], stream);
        return;
