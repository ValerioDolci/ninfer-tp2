...
| Qwen3.8-27B QUASAR-QAT (fork, two-GPU mode) | `nvfp4` | [Hugging Face](https://huggingface.co/Feyd89/Qwen3.8-27B-QUASAR-QAT-nvfp4-NInfer) | [model card](../model-cards/Qwen3.8-27B-QUASAR-QAT-nvfp4-NInfer/README.md) |
